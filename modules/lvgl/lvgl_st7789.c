...
// 1. 定义实际的C函数
static mp_obj_t lvgl_add(mp_obj_t a_obj, mp_obj_t b_obj) {
...
static MP_DEFINE_CONST_FUN_OBJ_2(lvgl_add_obj, lvgl_add);
...
static const mp_rom_map_elem_t lvgl_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_add), MP_ROM_PTR(&lvgl_add_obj) },
};
MP_DEFINE_CONST_DICT(lvgl_module_globals, lvgl_module_globals_table);
